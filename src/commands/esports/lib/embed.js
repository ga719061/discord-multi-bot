...
function formatValorantAgents(agents = []) {
  ...
  return agents
    .map((agent, index) => `**${index + 1}. ${agent.name}** ｜ ${agent.games} 場 ｜ 勝率 ${agent.winRate} ｜ KD ${agent.kd}`)
    .join('\n');
}
