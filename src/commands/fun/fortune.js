...
const fortuneTiers = [
    { min: 95, luck: '✨ 皇家神蹟', text: '哇！這運勢簡直像剛開罐的頂級罐罐！有神風助陣，想做什麼就大膽衝吧！', color: UI_COLORS.ROYAL },
    { min: 80, luck: '🐾 傲嬌大吉', text: '氣勢非常漂亮！本王封你為今日幸運星，做決定前喝口水，穩穩拿下勝利！', color: UI_COLORS.ROYAL },
    { min: 65, luck: '🍖 順風中吉', text: '好運正像點心一樣慢慢遞過來囉，保持你的節奏，準備張口咬住它！', color: UI_COLORS.SUCCESS },
    { min: 50, luck: '☀️ 晴空小吉', text: '今天整體還算順手啦！適合把手邊的小事情清理乾淨，溫和地前進吧。', color: UI_COLORS.INFO },
    { min: 35, luck: '☁️ 尾巴平穩', text: '今天不適合當拼命三郎，穩紮穩打守住基本盤，本王就覺得你很棒了！', color: UI_COLORS.MUTED },
    { min: 20, luck: '🌀 爪子打結', text: '哎呀，事情好像有點亂成一團？先別慌，像解開牽繩一樣，一條一條理清楚。', color: UI_COLORS.FUN },
    { min: 8, luck: '💥 國王警告', text: '今天脾氣有點像被踩到尾巴的吉娃娃？先冷靜，少說兩句，晚點再做決定！', color: UI_COLORS.WARNING },
    { min: 4, luck: '🥩 急需牛排', text: '能量見底啦！快去吃點好吃的，本王特許你今天可以理直氣壯地偷懶！', color: UI_COLORS.DANGER },
    { min: 1, luck: '💀 皇家大凶', text: '汪！！本王占出史上最黑暗的運勢！今天的你就像本王掉進浴缸……快逃回被窩，哪都別去！', color: UI_COLORS.DANGER },
];
