...
export const SHOP_ITEMS = {
    consumables: [
        ...
        { id: 'brave_potion', name: '勇敢藥水', emoji: '🍺', price: 500, type: 'consumable', quality: 'fine', effect: { type: 'buff', stats: { spd: 15, atk_pct: 10 }, turns: 5 }, desc: '5回合內 SPD+15, ATK+10%' },
        { id: 'wisdom_potion', name: '智慧藥水', emoji: '🧪', price: 500, type: 'consumable', quality: 'fine', effect: { type: 'buff', stats: { matk_pct: 15, mp_regen: 10 }, turns: 5 }, desc: '5回合內 MATK+15%, MP回復+10' },
        { id: 'defense_potion', name: '鋼鐵藥水', emoji: '🛡️', price: 500, type: 'consumable', quality: 'fine', effect: { type: 'buff', stats: { def: 20, dmg_reduction: 10 }, turns: 5 }, desc: '5回合內 DEF+20, 減傷+10%' },
        { id: 'focus_potion', name: '集中藥水', emoji: '🎯', price: 500, type: 'consumable', quality: 'fine', effect: { type: 'buff', stats: { crit: 15, hit_rate: 10 }, turns: 5 }, desc: '5回合內 暴擊+15%, 命中+10%' },
    ],
    weapons: [
